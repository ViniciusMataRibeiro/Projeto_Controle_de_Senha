...
<body>
	...
	List<Servicos> listServicos = dao.findAll(Servicos.class);
	%>
								...
								<table class="table align-middle mb-0 bg-white">
									<thead class="bg-light">
										...
										<a type="button" class="btn btn-outline-success"
											href="cadastroServico.jsp">Novo</a>
									</thead>
									<tbody>
										<%
										for (Servicos obj : listServicos) {
										...
										<tr>
											...
											<td>
												<p class="fw-normal mb-1"><%=obj.getNomeUsuario()%></p>
											</td>
											<td>
												<a type="button" class="fw-normal mb-1" href="<%=obj.getUrl()%>"><%=obj.getUrl()%></a>
											</td>
											<td>
											...
											<td style="text-align: center"><a type="button"
												...
												href="editServico.jsp?id=<%=obj.getId()%>">Editar</a> <a
												type="button" class="btn btn-outline-danger"
												href="<%=request.getContextPath()%>/ServletServico?servicoid=<%=obj.getId()%>">Excluir</a>
											</td>
										</tr>
										<%
										}
