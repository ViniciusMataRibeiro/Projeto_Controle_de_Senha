...
<body>
	...
	<%
	long servicoId = Long.parseLong(request.getParameter("id"));
								...
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<form action="ServletServico" method="post"
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												<input type="text" id="form3Example1c" class="form-control"
													placeholder="Url" name="Url" value="<%=servicos.getUrl()%>" />
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												<input type="text" id="form2Example22"
													class="form-control" placeholder="Senha" name="password"
													value="<%=servicos.getSenha()%>" />
											</div>
										</div>
